...
1. Mở `landing` → `/sponsor`: sponsor duyệt merchant, tạo campaign và phát Grant. Nhấn mạnh portal không có private key.
...
5. Mở merchant dashboard và Snowtrace: Grant unwrap → EIP-3009 → settlement → API trả dữ liệu.
